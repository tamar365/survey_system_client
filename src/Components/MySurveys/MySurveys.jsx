                 ...
                 {arrayOfDetailsOfSurveys.length ? arrayOfDetailsOfSurveys.map((boxOfSurvey) => (
                  <div className="surveyBox" key={boxOfSurvey._id}>
                      ...
                      <div className="containerOfSorveyBoxButtons">
                          <button className="sendButton btnMySurvey" id={boxOfSurvey._id} value={boxOfSurvey._id} onClick={(e) => goToSendUrlOfSurveyPage(e.target.value)}>שלח סקר<i className="fa fa-envelope-o"></i></button>
                          ...
                          <button className="answersButton btnMySurvey" id={boxOfSurvey._id} value={boxOfSurvey._id} onClick={(e) => goToAnswersPage(e.target.value)}>תשובות לסקר<i className="fa fa-group"></i></button>
                      </div>
                  </div>
                 )) : undefined}
              </div>
