          ...
          <div className="inputsContainer">
            ...
            <div className="questionsContainer">
              {questionsDecoded.map((question) =>
                question.optionOfQuestion === "שאלה פתוחה" ? (
                  <OpenQuestion
                    theTypeOfQuestion={question.optionOfQuestion}
                    theQuestion={question.theWrittenQuestion}
                    setUserAnswer={setUserAnswer}
                  />
                ) : question.optionOfQuestion === "שאלת דירוג" ? (
                  <ScaleQuestion
                    theTypeOfQuestion={question.optionOfQuestion}
                    theQuestion={question.theWrittenQuestion}
            ...
            <button className="saveButton" onClick={sendSurveyByClient}>
              שלח תשובות
            </button>
