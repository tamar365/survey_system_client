...
function App() {
  ...
  return (
      <Router>
        <Routes>
          <Route path="/" element={isAuthenticated ? <Home /> : (accessToUserSurveyPage && isAuthenticated) ? <SurveyForUser setAccessToUserSurveyPage={setAccessToUserSurveyPage}/> : <Navigate to="/login" replace />} />
