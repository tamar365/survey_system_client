...
function App() {
  ...
  return (
      <Router>
        <Routes>
          <Route path="/" element={isAuthenticated ? <Home /> : accessToUserSurveyPage ? <SurveyForUser setAccessToUserSurveyPage={setAccessToUserSurveyPage}/> : <Navigate to="/login" replace />} />
